              ...
              <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                  ...
                  <form method="POST" action="{{ route('superadmin.cluster.list') }}">
                    ...
                    <div class="py-4">
                      <label for="name" class="block text-md font-normal text-gray-700 mb-2 text-lg mb-2">Cluster Name</label>
                      
                      <input id="name" type="text" name="name" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Enter name of the cluster" :value="old('name')" required autofocus>

                      <label for="description" class="block text-md font-normal text-gray-700 mb-2 text-lg mt-5">Cluster Description</label>
                      
                      <textarea id="description" name="description" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Enter description of the cluster" :value="old('description')" required autofocus></textarea>
                    </div>
