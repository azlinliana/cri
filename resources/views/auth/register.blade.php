<x-guest-layout>
  ...
  <section class="min-h-screen flex items-stretch text-white gradient ">
    <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
      <div class="w-full py-6 z-20">
        ...
        <div class="text-xl font-bold my-6 uppercase">Sign Up for an Account</div>
        ...
        <form method="POST" action="{{ route('register') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
          ...
          <div class="pb-2 pt-4">
            <select id="title_user" class="select select-ghost w-full border-2 border-white text-lg rounded-lg text-gray-100" name="title_user" :value="old('title_user')" required autofocus>
          ...
          <div class="pb-2 pt-4">
            <input id="fullname" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="text" name="fullname" :value="old('fullname')" placeholder="Full Name" required autofocus />
          </div>

          <div class="pb-2 pt-4">
            <select id="gender" class="select select-ghost w-full border-2 border-white text-lg rounded-lg text-gray-100" name="gender" :value="old('gender')" required autofocus>
          ...
          <div class="pb-2 pt-4">
            <input id="organization" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="text" name="organization" :value="old('organization')" placeholder="University/Organization" required autofocus />
          </div>
          
          <div class="pb-2 pt-4">
            <input id="faculty" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="text" name="faculty" :value="old('faculty')" placeholder="Faculty" required autofocus />
          </div>

          <div class="pb-2 pt-4">
            <input id="address_line_one" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="text" name="address_line_one" :value="old('address_line_one')" placeholder="Address Line 1" required autofocus />
          </div>

          <div class="pb-2 pt-4">
            <input id="address_line_two" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="text" name="address_line_two" :value="old('address_line_two')" placeholder="Address Line 2" autofocus />
          </div>

          <div class="flex items-center justify-between">
            <div class="flex pb-2 pt-4 mr-2">
              <input id="area" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="text" name="area" :value="old('area')" placeholder="Area" required autofocus />
            </div>

            <div class="flex pb-2 pt-4 ml-2">
              <input id="state" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="text" name="state" :value="old('state')" placeholder="State" required autofocus />
            </div>
          </div>
          ...
          <div class="pb-2 pt-4">
            <input id="email" class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" type="email" name="email" :value="old('email')" placeholder="Email" required autofocus />
          </div>

          <div class="pb-2 pt-4" x-data="{ show: true }">
            <label class="relative block">
              <input id="password" 
                class="input input-ghost w-full border-2 border-white p-4 text-lg rounded-lg" 
          ...
          <div class="pb-2 pt-6">
            <button class="uppercase block w-full p-4 text-lg rounded-full bg-black hover:bg-white hover:text-black focus:outline-none" type="submit">Sign Up</button>
          </div>

          <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-white">
            <span>Already registered?</span>

            <a href="{{ route('login') }}" class="text-white font-bold hover:text-black no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign In</a>
          </p>
      ...
      <div class="fixed lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center" style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);">
        <div class="fixed bg-black opacity-60 inset-0 z-0"></div>
    ...
    <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);">
      ...
      <div class="w-full px-24 z-10">
        <div class="text-5xl font-bold text-left tracking-wide">Do join us</div>
        <p class="text-3xl my-4">Join us today and show us what you got.</p>
      </div>
