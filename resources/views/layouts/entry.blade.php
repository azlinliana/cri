      ...
      <main>
        ...
        @if (Auth::user()->hasRole('participant'))
            <div class="drawer">
                ...
                <div class="drawer-content">
                    <div class="flex-initial">
                        <div class="navbar bg-orange-400">
                            <div class="flex-1">
                            <label for="participant-drawer" class="btn btn-ghost btn-circle">
                                <i class="fa-solid fa-bars fa-lg" style="color: whitesmoke"></i>
                            </label>
                ...
                <div class="drawer-side">
                    <label for="participant-drawer" class="drawer-overlay"></label>
