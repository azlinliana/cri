    ...
    <div class="drawer-side">
        ...
        <ul class="menu pr-4 pl-4 overflow-y-auto w-80 bg-base-100 text-base-content space-y-2">
            <div class="mt-8 mb-8 text-center">
                ...
                <span class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-semibold bg-blue-700 text-white rounded-full">Admin</span>
            </div>
