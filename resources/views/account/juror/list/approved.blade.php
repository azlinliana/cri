      ...
      @section('content')
        ...
        <div class="btn-group btn-xs mb-12">
          <div class="btn btn-ghost bg-rose-500 hover:bg-rose-300">
            <a href="{{ route('juror.list.approved') }}">
          ...
          <div class="btn btn-ghost bg-rose-300 hover:bg-rose-500">
            <a href="{{ route('juror.grid.approved') }}">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="white">
                  ...
                  <div class="overflow-x-auto">
                    <div class="sm:flex items-center justify-between pl-1 mt-2 mb-4">
                      <div class="flex items-center">
                        ...
                        <a href="{{ route('juror.list.approved') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800">
                          ...
                          @foreach ($jurors as $juror)
                            @if ($juror->status == 'approved')
                              <tr class="border-b">
                                ...
                                <td class="text-sm text-gray-900 font-semibold px-6 py-4 whitespace-nowrap">
                                  <div class="py-3 px-3 text-sm text-center leading-none text-green-700 bg-green-100 rounded">Approved</div>
                                </td>
