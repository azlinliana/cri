                  ...
                  <div class="overflow-x-auto">
                    <div class="sm:flex items-center justify-between pl-1 mt-2 mb-4">
                      <div class="flex items-center">
                        <a href="{{ route('juror.list.all') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800">
                          <div class="py-2 lg:px-8 px-4 bg-rose-100 text-rose-700 rounded-full">
                            <p>All</p>
                          </div>
                        </a>
        
                        <a href="{{ route('juror.list.pending') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800 ml-4 sm:ml-8">
                          <div class="py-2 lg:px-8 px-4 text-gray-600 hover:text-rose-700 hover:bg-rose-100 rounded-full ">
                            <p>Pending</p>
                          </div>
                        </a>
        
                        <a href="{{ route('juror.list.approved') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800 ml-4 sm:ml-8">
                          <div class="py-2 lg:px-8 px-4 text-gray-600 hover:text-rose-700 hover:bg-rose-100 rounded-full ">
                            <p>Approved</p>
                          </div>
                        </a>
        
                        <a href="{{ route('juror.list.rejected') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800 ml-4 sm:ml-8">
                          <div class="py-2 lg:px-8 px-4 text-gray-600 hover:text-rose-700 hover:bg-rose-100 rounded-full">
                            <p>Rejected</p>
                          </div>
                        </a>
