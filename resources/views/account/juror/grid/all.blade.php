        ...
        <div class="overflow-x-auto">
          <div class="sm:flex items-center justify-between pl-1 mt-2 mb-4">
            <div class="flex items-center">
              <a href="{{ route('juror.grid.all') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800">
                <div class="py-2 lg:px-8 px-4 bg-rose-100 text-rose-700 rounded-full">
                  <p>All</p>
                </div>
              </a>

              <a href="{{ route('juror.grid.pending') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800 ml-4 sm:ml-8">
                ...
                <div class="w-full bg-white rounded-lg p-12 flex flex-col justify-center items-center shadow-xl">
                  ...
                  <div class="text-center">
                    ...
                    @if ($juror->status == 'approved')
                      <div class="inline-block py-3 px-3 text-sm text-center font-semibold leading-none text-green-700 bg-green-200 rounded-full">Approved</div>
                    @endif
