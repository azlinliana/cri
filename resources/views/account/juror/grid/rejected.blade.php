        ...
        <div class="overflow-x-auto">
          <div class="sm:flex items-center justify-between pl-1 mt-2 mb-4">
            <div class="flex items-center">
              ...
              <a href="{{ route('juror.grid.pending') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800 mr-4 sm:mr-8">
                <div class="py-2 lg:px-8 px-4 text-gray-600 hover:text-rose-700 hover:bg-rose-100 rounded-full">
                  <p>Pending</p>
                </div>
              </a>

              <a href="{{ route('juror.grid.approved') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800 mr-4 sm:mr-8">
                <div class="py-2 lg:px-8 px-4 text-gray-600 hover:text-rose-700 hover:bg-rose-100 rounded-full">
                  <p>Approved</p>
                </div>
              </a>

              <a href="{{ route('juror.grid.rejected') }}" class="rounded-full focus:outline-none focus:ring-2 focus:bg-rose-50 focus:ring-rose-800">
                ...
                @if ($juror->status == 'rejected')
                  <div class="w-full bg-white rounded-lg p-12 flex flex-col justify-center items-center shadow-xl">
                    ...
                    <div class="text-center">
                      ...
                      <div class="inline-block py-3 px-3 text-sm text-center font-semibold leading-none text-rose-50 bg-rose-400 rounded-full">Rejected</div>
