      ...
      <div class="drawer drawer-mobile">
        ...
        <div class="drawer-content flex flex-col">
          ...
          <div class="navbar bg-transparent">
            <div class="flex-1 ml-4">
              ...
              <div class="normal-case text-2xl font-semibold text-black">Dashboard.</div>
            </div>
            ...
            <div class="flex-none mr-4">
              <div class="hidden md:block">
                <form method="POST" action="" id="display_search_form" style="display: none" class="mr-2">
                  ...
                  <input type="text" name="" placeholder="Search here" class="input input-bordered w-full max-w-xs rounded-full focus:border-orange-300 transition" />
                </form>
              </div>
          ...
          <div class="flex flex-1 overflow-y-auto">
            <div class="w-full px-6 py-6 mx-auto">
              ...
              <div class="container min-h-screen mx-auto px-4 flex flex-col lg:flex-row bg-yellow-300">
                <div class="relative lg:w-2/3 rounded-xl bg-sky-200 bg-cover p-16">
                ...
                <div class="mt-6 lg:mt-0 lg:ml-6 lg:w-1/3 rounded-xl bg-green-100 p-8">
                    <div class="max-w-sm">
                      <p class="text-2xl font-semibold uppercase">Carnival Timeline</p>
              ...
              {{-- <div class="flex flex-wrap -mx-3 bg-indigo-100">
                <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
                  <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                      <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                          <div>
                            <p class="mb-0 font-sans font-semibold leading-normal text-sm">Total Entry</p>
                            <h5 class="mb-0 font-bold">
                              $53,000
                              <span class="leading-normal text-sm font-weight-bolder text-lime-500">+55%</span>
                            </h5>
                        ...
                        <div class="px-3 text-right basis-1/3">
                          <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-amber-500 to-orange-200">                            
                            <i class="fa-solid fa-file-circle-plus leading-none text-lg relative top-3.5 text-white"></i>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="drawer-side">
          ...
          <ul class="menu p-4 overflow-y-auto w-72 bg-base-100 space-y-2 tracking-wide mb-4">
            {{-- <form method="POST" action="" class="sm:block">
              @csrf
              
              <div hidden class="sm:block">
            ...
            <li>
              <a href="{{ route('dashboard') }}" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-orange-400 to-orange-200">
            ...
            <div class="collapse collapse-arrow">
              ...
              <div class="collapse-title">
                <div class="flex items-center space-x-4 rounded-md text-gray-600 group">
                  <i class="fa-solid fa-file-circle-plus"></i>
                  <span class="group-hover:text-gray-700">Project Entry</span>
                </div>
              </div>
              ...
              <div class="collapse-content">
                <li>
                  <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <span class="group-hover:text-gray-700">Entry list</span>
                  </a>
                </li>
                <li>
                  <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <span class="group-hover:text-gray-700">Add new entry</span>
                  </a>
                </li>
              </div>
            </div>
